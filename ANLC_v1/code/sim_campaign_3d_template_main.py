...
import utilities.sym_dyn_3d_template as sym_dyn
...
# Campaign parameters
campaign_run = 14  # number of the run.
...
system_name = "control_3d_template_campaign"
execute_postpro = True  #execute postprocessing
x_star = torch.tensor([0.5, -0.6, 0.0])  # target equilibrium point
...
for i_loop in range(tot_runs):
    ...
    exec(open("sim_campaign_3d_template_train.py").read())
